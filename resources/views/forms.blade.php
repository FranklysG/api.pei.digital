...
<body>
    ...
    <main style="
        ...
        <ol style="list-style-type: decimal">
            ...
            <span style="font-weight: 400">A mãe nos relatou sua preocupação sobre o crescimento de
            ...
            <table style="
                ...
                <tr>
                    <td style="
                                ...
                                padding: 8px;
                            ">
                        <span style="font-weight: 400">Desenvolver habilidade de resolução de
                            problemas</span>
                    </td>
                    <td style="
                                border: 1px solid black;
                                ...
                                padding: 8px;
                            ">
                        <span style="font-weight: 400">Segundo semestre</span>
                    </td>
                    <td style="
                                border: 1px solid black;
                                text-align: center;
                    ...
                    <td style="
                                ...
                                padding: 8px;
                            ">
                        <span style="font-weight: 400">Tablet, jogos didáticos, material dourado,
            ...
            <table style="
                ...
                <tr>
                    <td style="
                                ...
                                padding: 8px;
                            ">
                        <span style="font-weight: 400">Desenvolver a habilidade de ler e escrever com
                            letra cursiva</span>
                    </td>
                    <td style="
                                border: 1px solid black;
                    ...
                    <td style="
                                ...
                                padding: 8px;
                            ">
                        <span style="font-weight: 400">Ler palavras, frases e pequenos textos na letra
                            bastão</span>
                    </td>
                    <td style="
                                border: 1px solid black;
                    ...
                    <td style="
                                ...
                                padding: 8px;
                            ">
                        <span style="font-weight: 400">Textos diversos, Livros infantis, vídeos,
                ...
                <tr>
                    <td style="
                                ...
                                padding: 8px;
                            ">
                        <span style="font-weight: 400">Participar dos jogos e brincadeiras</span>
                    </td>
                    <td style="
                                border: 1px solid black;
                                text-align: center;
                    ...
                    <td style="
                                ...
                                padding: 8px;
                            ">
                        <span style="font-weight: 400">Demonstra pouco interesse e habilidades nas
                    ...
                    <td style="
                                ...
                                padding: 8px;
                            ">
                        <span style="font-weight: 400">Vídeos, bola, corda, cabo de vassoura, raquete
            ...
            <table style="
                ...
                <tr>
                    <td style="
                                ...
                                padding: 8px;
                            ">
                        <span style="font-weight: 400">Adquirir noções fundamentais sobre a higiene e
                    ...
                    <td style="
                                ...
                                padding: 8px;
                            ">
                        <span style="font-weight: 400">Ler livros e gibi sobre o tema</span>
                    </td>
                    <td style="
                                border: 1px solid black;
                                text-align: center;
                                padding: 8px;
                            ">
                        <span style="font-weight: 400">Confecção de cartazes sobre práticas e hábitos
                    ...
                    <td style="
                                ...
                                padding: 8px;
                            ">
                        <span style="font-weight: 400">Cartazes e Vídeos</span>
                    </td>
                </tr>
            </table>
            ...
            <table style="
                ...
                <tr>
                    <td style="
                                ...
                                padding: 8px;
                            ">
                        <span style="font-weight: 400">Reconhecer as formas de relevo através de
                    ...
                    <td style="
                                ...
                                padding: 8px;
                            ">
                        <span style="font-weight: 400">Diferencia paisagem natural de paisagem
                            cultural</span>
                    </td>
                    <td style="
                                border: 1px solid black;
                                ...
                                padding: 8px;
                            ">
                        <span style="font-weight: 400">Confecção de cartazes sobre o relevo</span>
                    </td>
                    <td style="
                                border: 1px solid black;
                                text-align: center;
                                padding: 8px;
                            ">
                        <span style="font-weight: 400">Computador, cartazes</span>
                    </td>
                </tr>
            </table>
            ...
            <table style="
                ...
                <tr>
                    <td style="
                                ...
                                padding: 8px;
                            ">
                        <span style="font-weight: 400">Melhorar a participação nas aulas</span>
                    </td>
                    <td style="
                                border: 1px solid black;
                                text-align: center;
                    ...
                    <td style="
                                ...
                                padding: 8px;
                            ">
                        <span style="font-weight: 400">Realiza as atividades escritas elaboradas pela
                            professora</span>
                    </td>
                    <td style="
                                border: 1px solid black;
            ...
            <table style="
                ...
                <tr>
                    ...
                    <td style="
                                ...
                                padding: 8px;
                            ">
                        <span style="font-weight: 400">Até o final do ano letivo</span>
                    </td>
                    <td style="
                                border: 1px solid black;
                                text-align: center;
                                padding: 8px;
                            ">
                        <span style="font-weight: 400">De vez enquando é perguntado se o aluno deseja
                            ir ao banheiro;</span>
                    </td>
                    <td style="
                                border: 1px solid black;
                ...
                <tr>
                    <td style="
                                ...
                                padding: 8px;
                            ">
                        <span style="font-weight: 400">Interagir socialmente com os colegas</span>
                    </td>
                    <td style="
                                border: 1px solid black;
                                text-align: center;
                    ...
                    <td style="
                                ...
                                padding: 8px;
                            ">
                        <span style="font-weight: 400">As vezes responde algo quando algum colega lhe
            ...
            <span style="font-weight: 400">Possibilitar a aprendizagem, a compreensão e apreensão dos
            ...
            <span style="font-weight: 400">Portfólio, Registros, trabalhos individuais e coletivos,
